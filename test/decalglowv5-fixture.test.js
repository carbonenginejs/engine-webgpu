...
@fragment fn main(input: FragmentInput) -> FragmentOutput {
  ...
  return {
    ...
    filePath: `E:/fixtures/unpacked_decalglowv5.${backend}.cewgpu`,
    resourcePath: `res:/webgpu-harness/decalglowv5/${backend}.cewgpu`,
    analysis: {
      source,
      bodyIndex: 0,
      ...
      stages: [
        ...
        },
        {
          ...
          bindings: [
            ...(backend === "dx11"
              ? [ samplerReflection(0, 4), samplerReflection(1, 1) ]
              : []),
