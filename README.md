...
non-bindless DecalV5, and kill-counter DecalCounterV5 draws through a
provisional Trinity-shaped batch dispatcher without loading SOF, a Trinity
graph, production defaults, or an EVE asset. The dispatcher imports no runtime
